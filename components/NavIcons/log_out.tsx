...
export const LogOut = () => ( 
    <StyledBackLogOut> 
        <StyledLogOut width="40" height="40" fill="url(#mygradient1)" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <linearGradient id="mygradient1" x1="13.333" y1="0" x2="13.333" y2="40" gradientUnits="userSpaceOnUse">
