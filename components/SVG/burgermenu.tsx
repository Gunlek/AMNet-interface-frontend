...
export default function  SVGBurgerMenu(props: {onClick?: Function}){
    return(
        <StyledBackBurger onClick={props.onClick}>
            <StyledIcon xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 8.996 8.996">
