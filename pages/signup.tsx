...
export default function SignUp() {
  ...
  const handleValueChange = (elmt) => {
    setGadz(
      elmt.target.value == "OldPromotion" ||
        elmt.target.value == "ActivePromotion"
    );
          ...
          <form method="post">
            ...
            >
              <Col6
                ...
                style={{ width: "100%" }}
              >
                <StyledInputLabel htmlFor="user_name">
                  Nom d'utilisateur
                </StyledInputLabel>
              ...
              >
                <BlackText
                  style={{ textAlign: minWidth1000 ? "start" : "justify" }}
                >
                  Votre nom d'utilisateur ne doit contenir que des lettres, des
            ...
            <ResponsiveRow style={{ marginBottom: "20px" }}>
              <Col3 paddingRight="10px" mobileMarginBottom="20px">
                <StyledInputLabel htmlFor="user_firstname">
                  Prénom
                </StyledInputLabel>
              ...
              <Col6 paddingLeft="10px">
                <StyledInputLabel htmlFor="user_email">
                  Adresse e-mail
                </StyledInputLabel>
            ...
            <ResponsiveRow style={{ marginBottom: "20px" }}>
              <Col6 paddingRight="10px" mobileMarginBottom="20px">
                <StyledInputLabel htmlFor="user_phone">
                  Téléphone
                </StyledInputLabel>
              ...
              <Col6 paddingLeft="10px">
                <StyledInputLabel
                  htmlFor={isOther ? "user_promotion2" : "user_promotion"}
                >
                  Promotion
                </StyledInputLabel>
                <StyledSelect
                ...
                >
                  <StyledInput id="user_promotion2" type="text" />
                  <StyledImg
                    padding="0"
                    width="35px"
                    marginLeft="20px"
            ...
            >
              <Col6 paddingRight="10px" mobileMarginBottom="20px">
                <StyledInputLabel htmlFor="user_bucque">
                  Bucque
                </StyledInputLabel>
              ...
              <Col3 paddingLeft="10px">
                <StyledInputLabel htmlFor="user_campus">
                  Tabagn's
                </StyledInputLabel>
            ...
            <ResponsiveRow style={{ marginBottom: "20px" }}>
              <Col6 paddingRight="10px" mobileMarginBottom="20px">
                <StyledInputLabel htmlFor="user_password">
                  Mot de passe
                </StyledInputLabel>
              ...
              <Col6 paddingLeft="10px">
                <StyledInputLabel htmlFor="user_password2">
            ...
            <Column style={{ alignItems: "start", marginBottom: "20px" }}>
              ...
              <BlackP>
                AMNet Birse est une association Loi 1901, vous devez en accepter
                les statuts et le réglement intérieur. La validation de ce
                formulaire et le réglement de la cotisation annuelle (35€) vaut
                pour adhésion à l'association.
              </BlackP>
            </Column>
