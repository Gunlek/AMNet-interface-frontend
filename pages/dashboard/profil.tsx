...
import { BlackTitle, GreenText, BlackText } from "../../components/Text/style";
      ...
      <DashboardContainer>
        ...
        >
          ...
          >
            ...
            >
              <GreenText style={{ marginBottom: "5px" }}>
                Identifiants gadzariques
              </GreenText>
              <StyledInput
                hoverBorder="transparent"
                readOnly
                value="Mac Nhat'sss 47-102Li219"
                type="text"
              />
            </Col6>
            <Col6
