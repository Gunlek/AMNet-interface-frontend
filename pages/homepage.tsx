        ...
        <StyledFlexCol justify="space-around">
          ...
          <StyledFlexRow width="90%" height="50%">
            <StyledFlexDiv grow="2" width="45%">
              <StyledWhiteText>
                L’AMNet est une association gérée par les étudiants qui a pour
                but d’administrer le réseau internet de la résidence Jacques
                Pagliero. Elle est totalement indépendante de l’administration
                de la résidence ou de l’école.<br></br>
                <br></br>Votre cotisation sert à améliorer l’installation ainsi
                qu’à payer les abonnements internet. Chaque année, 80% des
                cotisations est utilisé directement et les 20% restants servent
                à créer une trésorerie pour des investissements futurs.
              </StyledWhiteText>
            </StyledFlexDiv>
            <StyledFlexDiv grow="2">
              <TeamPicture
            ...
            <StyledFlexRow>
              ...
              <StyledFlexCol width="calc(100% - 250px)">
                <StyledFlexRow height="50px" width="100%" justify="start">
                  <StyledFlexDiv width="200px">
                    <StyledGreenText>Serveur Minecraft</StyledGreenText>
                  </StyledFlexDiv>
                  <StyledFlexDiv width="calc(100% - 200px)" height="0px">
                ...
                <StyledFlexDiv width="100%">
                  <StyledBlackText>
                    ...
                    <br></br>
                    <br></br>
                    Si vous avez des idées de services que nous pourrions
                    proposer hésitez pas à nous contacter !
                  </StyledBlackText>
                  <StyledBlackText></StyledBlackText>
                </StyledFlexDiv>
              </StyledFlexCol>
            </StyledFlexRow>
          </StyledCard>
          <StyledFlexRow width="90%" height="1.1rem">
